...
void Vsa_tb_std__03a__03amailbox__Tz1::__VnoInFunc_num(Vsa_tb__Syms* __restrict vlSymsp, IData/*31:0*/ &num__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vsa_tb_std__03a__03amailbox__Tz1::__VnoInFunc_num\n"); );
    // Body
...
Vsa_tb_std__03a__03amailbox__Tz1::~Vsa_tb_std__03a__03amailbox__Tz1() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vsa_tb_std__03a__03amailbox__Tz1::~\n"); );
}

std::string VL_TO_STRING(const VlClassRef<Vsa_tb_std__03a__03amailbox__Tz1>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vsa_tb_std__03a__03amailbox__Tz1::VL_TO_STRING\n"); );
    // Body
    return (obj ? obj->to_string() : "null");
}

std::string Vsa_tb_std__03a__03amailbox__Tz1::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vsa_tb_std__03a__03amailbox__Tz1::to_string\n"); );
    // Body
    return (std::string{"'{"} + to_string_middle() + "}");
}

std::string Vsa_tb_std__03a__03amailbox__Tz1::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vsa_tb_std__03a__03amailbox__Tz1::to_string_middle\n"); );
    // Body
    std::string out;
