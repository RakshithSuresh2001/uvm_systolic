...
VlCoroutine Vsa_tb___024unit__03a__03asa_directed_seq::__VnoInFunc_run(Vsa_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vsa_tb___024unit__03a__03asa_directed_seq::__VnoInFunc_run\n"); );
    // Init
    VL_KEEP_THIS;
    // Body
    ...
    VL_WRITEF("[SEQ] Directed: identity weights\n");
    w[0U][0U] = 1U;
    w[0U][1U] = 0U;
    w[0U][2U] = 0U;
    w[0U][3U] = 0U;
    ...
    a[1U] = 0xffU;
    unnamedblk2_2__DOT__r = 2U;
    a[2U] = 0xffU;
    unnamedblk2_2__DOT__r = 3U;
    a[3U] = 0xffU;
    unnamedblk2_2__DOT__r = 4U;
    a[4U] = 0xffU;
    unnamedblk2_2__DOT__r = 5U;
    a[5U] = 0xffU;
    unnamedblk2_2__DOT__r = 6U;
    a[6U] = 0xffU;
