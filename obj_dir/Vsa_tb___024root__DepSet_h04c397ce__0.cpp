...
VL_INLINE_OPT VlCoroutine Vsa_tb___024root___eval_initial__TOP__Vtiming__0(Vsa_tb___024root* vlSelf) {
    ...
    std::string __Vtask_sa_tb__DOT__run_test__23__name;
    // Body
    ...
    co_await vlSelf->__VtrigSched_h31f193c6__0.trigger(0U, 
                                                       ...
                                                       "tb/sa_tb.sv", 
                                                       144);
    __Vtask_sa_tb__DOT__run_test__23__name = vlSelf->sa_tb__DOT__test_name;
    if ((std::string{"directed"} == __Vtask_sa_tb__DOT__run_test__23__name)) {
        co_await VL_NULL_CHECK(vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk2__DOT__s, "tb/sa_tb.sv", 99)->__VnoInFunc_run(vlSymsp);
    } else if ((std::string{"allones"} == __Vtask_sa_tb__DOT__run_test__23__name)) {
        co_await VL_NULL_CHECK(vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk3__DOT__s, "tb/sa_tb.sv", 100)->__VnoInFunc_run(vlSymsp);
    } else if ((std::string{"random"} == __Vtask_sa_tb__DOT__run_test__23__name)) {
        co_await VL_NULL_CHECK(vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk4__DOT__s, "tb/sa_tb.sv", 101)->__VnoInFunc_run(vlSymsp);
    } else if (VL_UNLIKELY((std::string{"full"} == __Vtask_sa_tb__DOT__run_test__23__name))) {
        VL_WRITEF("[TB] Full regression\n");
        co_await VL_NULL_CHECK(vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk5__DOT__ds, "tb/sa_tb.sv", 108)->__VnoInFunc_run(vlSymsp);
        co_await VL_NULL_CHECK(vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk5__DOT__unnamedblk6__DOT__idle, "tb/sa_tb.sv", 109)->__VnoInFunc_send_idle(vlSymsp, 0x28U);
        co_await VL_NULL_CHECK(vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk5__DOT__as, "tb/sa_tb.sv", 110)->__VnoInFunc_run(vlSymsp);
        co_await VL_NULL_CHECK(vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk5__DOT__unnamedblk7__DOT__idle, "tb/sa_tb.sv", 111)->__VnoInFunc_send_idle(vlSymsp, 0x28U);
        co_await VL_NULL_CHECK(vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk5__DOT__rs, "tb/sa_tb.sv", 112)->__VnoInFunc_run(vlSymsp);
        co_await VL_NULL_CHECK(vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk5__DOT__unnamedblk8__DOT__idle, "tb/sa_tb.sv", 113)->__VnoInFunc_send_idle(vlSymsp, 0x28U);
        co_await VL_NULL_CHECK(vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk5__DOT__cs, "tb/sa_tb.sv", 114)->__VnoInFunc_run(vlSymsp);
    } else {
        co_await VL_NULL_CHECK(vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk9__DOT__s, "tb/sa_tb.sv", 116)->__VnoInFunc_run(vlSymsp);
    }
    ...
    VL_NULL_CHECK(vlSelf->sa_tb__DOT__sb, "tb/sa_tb.sv", 148)->__VnoInFunc_report(vlSymsp);
    VL_NULL_CHECK(vlSelf->sa_tb__DOT__cov, "tb/sa_tb.sv", 149)->__VnoInFunc_report(vlSymsp);
    VL_FINISH_MT("tb/sa_tb.sv", 150, "");
}
