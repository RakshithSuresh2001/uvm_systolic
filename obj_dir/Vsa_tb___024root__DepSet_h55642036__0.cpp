...
VL_INLINE_OPT VlCoroutine Vsa_tb___024root___eval_initial__TOP__Vtiming__0(Vsa_tb___024root* vlSelf) {
    ...
    std::string __Vtask_sa_tb__DOT__run_test__17__name;
    // Body
    vlSymsp->TOP____024unit.g_drv_mbx = VL_NEW(Vsa_tb_std__03a__03amailbox__Tz1, vlSymsp, 0U);
    vlSymsp->TOP____024unit.g_mon_mbx = VL_NEW(Vsa_tb_std__03a__03amailbox__Tz1, vlSymsp, 0U);
    ...
    co_await vlSelf->__VtrigSched_h31f193c6__0.trigger(0U, 
                                                       ...
                                                       "tb/sa_tb.sv", 
                                                       107);
    __Vtask_sa_tb__DOT__run_test__17__name = vlSelf->sa_tb__DOT__test_name;
    if ((std::string{"directed"} == __Vtask_sa_tb__DOT__run_test__17__name)) {
        co_await VL_NULL_CHECK(vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk1__DOT__s, "tb/sa_tb.sv", 70)->__VnoInFunc_run(vlSymsp);
    } else if ((std::string{"allones"} == __Vtask_sa_tb__DOT__run_test__17__name)) {
        co_await VL_NULL_CHECK(vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk2__DOT__s, "tb/sa_tb.sv", 71)->__VnoInFunc_run(vlSymsp);
    } else if ((std::string{"random"} == __Vtask_sa_tb__DOT__run_test__17__name)) {
        co_await VL_NULL_CHECK(vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk3__DOT__s, "tb/sa_tb.sv", 72)->__VnoInFunc_run(vlSymsp);
    } else if (VL_UNLIKELY((std::string{"full"} == __Vtask_sa_tb__DOT__run_test__17__name))) {
        VL_WRITEF("[TB] Full regression\n");
        co_await VL_NULL_CHECK(vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk4__DOT__ds, "tb/sa_tb.sv", 78)->__VnoInFunc_run(vlSymsp);
        co_await VL_NULL_CHECK(vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk4__DOT__as, "tb/sa_tb.sv", 78)->__VnoInFunc_run(vlSymsp);
        co_await VL_NULL_CHECK(vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk4__DOT__rs, "tb/sa_tb.sv", 78)->__VnoInFunc_run(vlSymsp);
    } else {
        co_await VL_NULL_CHECK(vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk5__DOT__s, "tb/sa_tb.sv", 80)->__VnoInFunc_run(vlSymsp);
    }
    sa_tb__DOT____Vrepeat3 = 0x258U;
    ...
    VL_NULL_CHECK(vlSelf->sa_tb__DOT__sb, "tb/sa_tb.sv", 111)->__VnoInFunc_report(vlSymsp);
    VL_NULL_CHECK(vlSelf->sa_tb__DOT__cov, "tb/sa_tb.sv", 112)->__VnoInFunc_report(vlSymsp);
    VL_FINISH_MT("tb/sa_tb.sv", 113, "");
}
