...
VlCoroutine Vsa_tb___024unit__03a__03asa_allones_seq::__VnoInFunc_run(Vsa_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vsa_tb___024unit__03a__03asa_allones_seq::__VnoInFunc_run\n"); );
    // Init
    VL_KEEP_THIS;
    // Body
    ...
    VL_WRITEF("[SEQ] All-ones weights\n");
    w[0U][0U] = 1U;
    w[0U][1U] = 1U;
    w[0U][2U] = 1U;
    w[0U][3U] = 1U;
