...
VL_INLINE_OPT VlCoroutine Vsa_tb___024root___eval_initial__TOP__Vtiming__0____Vfork_1__1(Vsa_tb___024root* vlSelf) {
    ...
    while (1U) {
        ...
        VL_NULL_CHECK(vlSelf->sa_tb__DOT__monitor_run__Vstatic__txn, "tb/sa_tb.sv", 57)->__PVT__weight_load 
            = vlSelf->sa_tb__DOT__weight_load;
        VL_NULL_CHECK(vlSelf->sa_tb__DOT__monitor_run__Vstatic__txn, "tb/sa_tb.sv", 58)->__PVT__weight_row 
            = vlSelf->sa_tb__DOT__weight_row;
        VL_NULL_CHECK(vlSelf->sa_tb__DOT__monitor_run__Vstatic__txn, "tb/sa_tb.sv", 59)->__PVT__weight_data 
            = vlSelf->sa_tb__DOT__weight_data;
        VL_NULL_CHECK(vlSelf->sa_tb__DOT__monitor_run__Vstatic__txn, "tb/sa_tb.sv", 60)->__PVT__act_in 
            = vlSelf->sa_tb__DOT__act_in;
        VL_ASSIGN_W(256,VL_NULL_CHECK(vlSelf->sa_tb__DOT__monitor_run__Vstatic__txn, "tb/sa_tb.sv", 61)
                    ->__PVT__psum_out, vlSelf->sa_tb__DOT__psum_out);
        co_await VL_NULL_CHECK(vlSymsp->TOP____024unit.g_mon_mbx, "tb/sa_tb.sv", 63)->__VnoInFunc_put(vlSymsp, vlSelf->sa_tb__DOT__monitor_run__Vstatic__txn);
        VL_NULL_CHECK(vlSelf->sa_tb__DOT__sb, "tb/sa_tb.sv", 64)->__VnoInFunc_check_direct(vlSymsp, vlSelf->sa_tb__DOT__monitor_run__Vstatic__txn, vlSelf->sa_tb__DOT__psum_out);
    }
}
