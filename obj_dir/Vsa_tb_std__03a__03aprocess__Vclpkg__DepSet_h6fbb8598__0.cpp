...
void Vsa_tb_std__03a__03aprocess__Vclpkg::__VnoInFunc_self(VlProcessRef vlProcess, Vsa_tb__Syms* __restrict vlSymsp, VlClassRef<Vsa_tb_std__03a__03aprocess> &self__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vsa_tb_std__03a__03aprocess__Vclpkg::__VnoInFunc_self\n"); );
    // Body
    VlClassRef<Vsa_tb_std__03a__03aprocess> p;
    p = VL_NEW(Vsa_tb_std__03a__03aprocess, vlSymsp);
...
void Vsa_tb_std__03a__03aprocess::__VnoInFunc_suspend(Vsa_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vsa_tb_std__03a__03aprocess::__VnoInFunc_suspend\n"); );
    // Body
...
VlCoroutine Vsa_tb_std__03a__03aprocess::__VnoInFunc_await(Vsa_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vsa_tb_std__03a__03aprocess::__VnoInFunc_await\n"); );
    // Init
    VL_KEEP_THIS;
...
Vsa_tb_std__03a__03aprocess::Vsa_tb_std__03a__03aprocess(Vsa_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vsa_tb_std__03a__03aprocess::new\n"); );
    // Init
    _ctor_var_reset(vlSymsp);
}

void Vsa_tb_std__03a__03aprocess::_ctor_var_reset(Vsa_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vsa_tb_std__03a__03aprocess::_ctor_var_reset\n"); );
    // Body
