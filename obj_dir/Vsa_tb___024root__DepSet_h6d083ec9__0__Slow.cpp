...
VL_ATTR_COLD void Vsa_tb___024root___eval_static__TOP(Vsa_tb___024root* vlSelf) {
    ...
    // Body
    vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk1__DOT__s 
    ...
    vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk4__DOT__ds 
        = VL_NEW(Vsa_tb___024unit__03a__03asa_directed_seq, vlSymsp);
    vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk4__DOT__as 
        = VL_NEW(Vsa_tb___024unit__03a__03asa_allones_seq, vlSymsp);
    vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk4__DOT__rs 
        = VL_NEW(Vsa_tb___024unit__03a__03asa_random_seq, vlSymsp, 5U);
    vlSelf->sa_tb__DOT__run_test__Vstatic__unnamedblk5__DOT__s 
        = VL_NEW(Vsa_tb___024unit__03a__03asa_directed_seq, vlSymsp);
}
